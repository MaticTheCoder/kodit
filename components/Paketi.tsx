  ...
  return (
    <section id="paketi" className="pt-20 pb-10 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-[#f8f9fa] rounded-2xl border border-[#dee2e6] p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
          ...
          <div className="text-right shrink-0">
            ...
            <span className="text-[#6c757d] text-sm">/mesec</span>
